            ...
            <Container>
                <Row>
                    <DropdownButton id="dropdown-basic-button" title={`${currentCategory}`}>
                        <Dropdown.Item className='d-flex justify-content-between align-items-center px-2'>
