    ...
    return (
        <div className='container flex-grow-1 p-3 m-2 rounded custom'>
            ...
            <div className="container border rounded mb-2 d-flex flex-column align-items-start">
                <h4 className="m-auto">Mascotas:</h4>
                ...
                <Table>
                    ...
                    <tbody>
                        {pets.map(pet => <tr className="d-flex" key={String(pet.name)}>
                            <td className="col-6">{pet.name}</td>
            ...
            {show && modal == "createPet" &&
                <CustomModal title="Crear Mascota">
                    <CreatePet updateList={getPets} clientId={currentClient.id}></CreatePet>
                </CustomModal>}
            {show && modal == "petDetail" &&
                <CustomModal title={currentPet.name}>
                    <PetDetail pet={currentPet}></PetDetail>
                </CustomModal>}
        </div>
    )
}
