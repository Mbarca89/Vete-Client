...
const PetDetail = () => {
    ...
    return (
        loading ? <Spinner /> : currentPet.id && <div className='container flex-grow-1 p-3 m-2 rounded custom overflow-auto'>
            ...
            <img className="w-50 mb-1" src={currentPet.photo ? `data:image/jpeg;base64,${currentPet.photo}` : noImage} alt="" />
